package com.apps.michaeldow.cutransitcompanion.main_activity.map
...
class BusMapFragment: Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DataBindingUtil.inflate(inflater, com.apps.michaeldow.cutransitcompanion.R.layout.fragment_bus_map, container, false)
